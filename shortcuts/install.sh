...
case "$DE" in
    ...
    *)
        ...
        echo ""
        echo "  Ctrl+Alt+S: $SCRIPT_DIR/../speak_selection.sh"
        echo "  Ctrl+Alt+Q: $SCRIPT_DIR/../stop_speaking.sh"
        echo ""
...
echo "  Ctrl+Alt+S - Speak from cursor"
echo "  Ctrl+Alt+C - Speak selection (clipboard)"
echo "  Ctrl+Alt+Q - Stop speaking"
echo ""
