...
case "$DE" in
    ...
    *)
        ...
        echo ""
        echo "  Shift+Alt+F: $SCRIPT_DIR/../speak_from_cursor.sh"
        echo "  Shift+Alt+D: $SCRIPT_DIR/../speak_active_doc.sh"
...
echo "  Shift+Alt+F - Speak from cursor"
echo "  Shift+Alt+D - Read active document"
